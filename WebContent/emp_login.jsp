...
<body>
    ...
    <div class="container">
        <form action="employee_login" method="post" class="needs-validation" novalidate>
            <div class="container">
                <div class="row form-group">
                    <label for="email ">Email :</label>
                    <input type="email" id="email" name="email" class="form-control" placeholder="Email address..." required
                        autofocus>
                    <div class="invalid-feedback">Enter a email address correctly</div>
                </div>
                <div class="row form-group">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            <a href="signup.html" type="button" class="btn btn-lg btn-primary btn-block"
                                title="Register Now!">SignUp</a>
                        </div>
                    </div>
                </div>
            </div>
