...
<body>
	...
	<div class="container tab" style="background-color: #ffffff19;">
        <form action="employee_update" method="post" class="needs-validation form1 shadow-lg" novalidate>
	            ...
	            <%
		        	try { 
		   	         ...
		   	         System.out.println("Fetching Profile details from emp_details..."); 
		   	         
		   	      	 HttpSession httpSession=request.getSession();
			   	     
		   	         System.out.println("Your Email Address : "+ httpSession.getAttribute("email"));
		   	         String sql = "SELECT * FROM EMP_DETAILS where email='"+httpSession.getAttribute("email")+"'";
