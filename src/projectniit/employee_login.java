...
public class employee_login extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			System.out.println("Searching for "+email+" from emp_details"); 
        
			// Query for Finding email id
			String sql = "SELECT * FROM EMP_DETAILS where email='"+email+"'";
			...
			System.err.println("Error in Employee Login Page : " + e);
			PrintWriter pw=response.getWriter();
			pw.print(e);
		}
	}
