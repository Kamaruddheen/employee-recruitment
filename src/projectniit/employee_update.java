...
public class employee_update extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			System.out.println("--- User Employee Details---\n"+ name +"\n"+ email +"\n"+ password +"\n"+ city +"\n"+ skill);
			...
			Class.forName("org.h2.Driver"); 
 	        ...
 	        System.out.println("Updating Profile details for "+email+" in EMP_details..."); 
 	        
 	        // Query for Finding email id
 	        String sql = "update EMP_DETAILS set name='"+name+"', email='"+email+"', password='"+password+"', city='"+city+"', skill= '"+skill+"' where email='"+email+"'";
